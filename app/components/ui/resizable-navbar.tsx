...
export const MobileNavToggle = ({
  ...
  return (
    <button
      ...
      className="flex items-center justify-center h-11 w-11 rounded-full hover:bg-white/10 transition-colors"
    >
      {isOpen ? (
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-6 py-2.5 rounded-md bg-white button bg-white text-black text-base font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
